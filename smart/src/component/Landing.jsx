            ...
            <div className="navigasi d-flex justify-content-between align-items-center">
                ...
                <div className="menu d-flex align-items-center">
                    <div className="menu-item d-flex">
                        <div className="state">
                            <a href="#hero" className="menu-title text-decoration-none">Beranda</a>
                        </div>
                        <div className="ms-4 state">
                            <a href="#tentang-kami" className="menu-title text-decoration-none">Tentang Kami</a>
                        </div>
                        <div className="ms-4 state">
                            <a href="#layanan" className="menu-title text-decoration-none">Layanan</a>
                        </div>
                    </div>
                    <div className="log d-flex ms-5">
